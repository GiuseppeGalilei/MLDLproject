...
We added the option to set the normalization layer type by passing an argument when calling ResNet49.
"""
import torch
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, norm_type='Batch Norm'):
        ...
        self.in_planes = 16
        # self.upsampling = nn.Conv2d(self.in_planes, 64, kernel_size=1, stride=1, bias=False)
